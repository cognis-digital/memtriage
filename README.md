...
[![PyPI](https://img.shields.io/pypi/v/cognis-memtriage.svg)](https://pypi.org/project/cognis-memtriage/)
[![CI](https://github.com/cognis-digital/memtriage/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/memtriage/actions)
...
MEMTRIAGE exists for one job — triage memory-dump artifacts: strings, iocs, suspicious processes from a dump export — and does it without a SaaS bill or heavyweight setup.
...
```bash
memtriage --version
memtriage scan .                      # scan the current project
memtriage scan . --format json
memtriage scan . --fail-on high       # non-zero exit for CI gates
memtriage mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **Volatility**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`memtriage` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
