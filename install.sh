#!/usr/bin/env sh
# Universal installer for memtriage. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/memtriage.git"
echo "Installing memtriage ..."
