...
import argparse, sys
from memtriage.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="memtriage", description="MEMTRIAGE — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from memtriage.mcp_server import serve
        return serve()
    if args.cmd == "scan":
